...
class MudElementReference {
    ...
    /**
     * Sets attributes on every child of an element which matches a selector.
     * Used to hide framework-generated elements (such as virtualization spacers) from the accessibility tree.
     */
    setChildrenAttributes(element, selector, attributes) {
        if (!element || !selector || !attributes)
            return;
